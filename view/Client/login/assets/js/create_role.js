document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', function(e) {
        ...
        fetch('http://localhost/projet-web/controller/components/login/create_role.php', {
            method: 'POST',
            body: formData
        })
            .then(response => {
            ...
            .then(data => {
                ...
                if (data.success) {
                    form.reset();
                    setTimeout(() => {
                        window.location.href = 'http://localhost/projet-web/view/Admin/login/src/dashboard.php';
