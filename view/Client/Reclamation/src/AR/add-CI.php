...
if($_POST) {
    ...
    if(empty($errors)) {
        ...
        if($controller->addReclamation($user, $sujet, $description, $statut)) {
            $success = "RÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©clamation ajoutÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e avec succÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s!";
            // RÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©initialiser le formulaire
            $_POST = array();
        } else {
            $error = "Erreur lors de l'ajout de la rÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©clamation";
        }
    } else {
    ...
    <section style="width: 60%; margin: 0 auto;">
        ...
        <form method="POST" action="">
            ...
            <div style="text-align: center;">
                <button type="submit" class="valider">أضف مطالبة</button>
