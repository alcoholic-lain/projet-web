...
<head>
    <meta charset="UTF-8">
    <title>Ajouter une RÃƒÂ©clamation</title>
    ...
    <section style="width: 60%; margin: 0 auto;">
        ...
        <form method="POST" action="">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="sujet" value="Probleme_de_securité" readonly
                       style="width: 100%; padding: 12px; border-radius: 10px; background: rgba(255,255,255,0.05); border: 1px solid var(--purple); color: white;">
            </div>
            ...
            <div style="text-align: center;">
                ...
                <a href="../choix.php" class="rejeter" style="margin-left: 10px;">يلغي</a>
            </div>
        </form>
    </section>
</main>
