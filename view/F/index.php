...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-4 shadow-sm">
    <div class="container-fluid">
        <a class="navbar-brand fw-bold" href="index.php?c=chat&a=index">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <li class="nav-item">
                        <a class="nav-link<?= in_array($page, ['listConversations', 'conversation', 'newConversation']) ? ' active' : ''; ?>"
                           href="index.php?c=chat&a=listConversations">Chat</a>
                    </li>
                    <?php if (($_SESSION['role'] ?? 'front') === 'back'): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="index.php?c=admin&a=index">Backoffice</a>
                        </li>
                    <?php endif; ?>
                <?php endif; ?>
            </ul>
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <a class="btn btn-outline-light btn-sm" href="index.php?c=chat&a=logout">Logout</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-pane fade show active" id="login-tab-pane" role="tabpanel">
                        <div class="card shadow-sm">
                            <div class="card-body">
                                ...
                                <form method="post" action="index.php?c=chat&a=login">
                                    <div class="mb-3">
                    ...
                    <div class="tab-pane fade" id="register-tab-pane" role="tabpanel">
                        <div class="card shadow-sm mt-3 mt-md-0">
                            <div class="card-body">
                                ...
                                <form method="post" action="index.php?c=chat&a=register">
                                    <div class="mb-3">
            ...
            <div class="col-md-4 mb-3">
                <div class="card shadow-sm h-100">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="index.php?c=chat&a=newConversation"
                    ...
                    <div class="list-group list-group-flush sidebar-conversations">
                        <?php foreach ($conversations as $c): ?>
                            ...
                            ?>
                            <a href="index.php?c=chat&a=conversation&id=<?= (int)$c['id']; ?>"
            ...
            <div class="col-md-8">
                <div class="card shadow-sm h-100 d-flex align-items-center justify-content-center glass-card">
                    <div class="card-body text-center">
                        ...
                        <a href="index.php?c=chat&a=newConversation" class="btn btn-primary">
                    ...
                    <div class="collapse mb-2" id="renameConversationForm">
                        <div class="card card-body py-2 px-3 shadow-sm">
                            <form class="row g-2 align-items-center"
                                  method="post"
                                  action="index.php?c=chat&a=renameConversation&id=<?= (int)$conversation->getId(); ?>">
                                <div class="col-sm-8">
                            ...
                            <div class="message <?= $isOwn ? 'message-own' : 'message-other'; ?>"
                                ...
                                <?php if ($isOwn): ?>
                                    <div class="actions mt-1">
                                        ...
                                        <!-- Unsend (delete) -->
                                        <form method="post"
                                              action="index.php?c=chat&a=conversation&id=<?= (int)$conversation->getId(); ?>"
                                              class="d-inline">
            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <form method="post" action="index.php?c=chat&a=newConversation">
                            <div class="mb-3">
