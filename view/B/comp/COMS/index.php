...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php?c=chatA&a=index">Admin Panel</a>
        ...
        <div class="collapse navbar-collapse" id="navbarAdmin">
            ...
            <a class="btn btn-outline-light btn-sm me-2"
               href="index.php?c=chatC&a=listConversations">
                Frontoffice
            </a>
            <a class="btn btn-outline-light btn-sm"
               href="index.php?c=chatC&a=logout">
                Logout
            </a>
        </div>
    </div>
        ...
        <div class="col-md-9">
            ...
            <?php elseif ($page === 'users'): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-outline-primary"
                                           href="index.php?c=chatA&a=users&edit_id=<?= $u->getId(); ?>">Edit</a>
                                        <a class="btn btn-sm btn-outline-danger"
                                           href="index.php?c=chatA&a=deleteUser&id=<?= $u->getId(); ?>"
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="post" action="index.php?c=chatA&a=saveUser">
            ...
            <?php elseif ($page === 'conversations'): ?>
                        ...
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <?php foreach ($conversations as $c): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-outline-primary"
                                           href="index.php?c=chatA&a=viewConversation&id=<?= $c->getId(); ?>">View</a>
                                        <a class="btn btn-sm btn-outline-secondary"
                                           href="index.php?c=chatA&a=conversations&edit_id=<?= $c->getId(); ?>">Edit</a>
                                        <a class="btn btn-sm btn-outline-danger"
                                           href="index.php?c=chatA&a=deleteConversation&id=<?= $c->getId(); ?>"
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="post" action="index.php?c=chatA&a=saveConversation">
                            <input type="hidden" name="id"
            ...
            <?php elseif ($page === 'conversationDetail'): ?>
                ...
                <div class="card shadow-sm mb-3">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <a class="btn btn-sm btn-outline-danger"
                               href="index.php?c=chatA&a=deleteConversation&id=<?= $conversation->getId(); ?>"
                            ...
                            <ul class="list-group list-group-flush">
                                <?php foreach ($participants as $p): ?>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            <a class="btn btn-sm btn-outline-danger"
                                               href="index.php?c=chatA&a=removeParticipant&conversation_id=<?= $conversation->getId(); ?>&user_id=<?= (int)$p['user_id']; ?>"
                                    ...
                                    <div class="message">
                                        ...
                                        <div class="actions">
                                            <a class="btn btn-sm btn-link text-danger p-0"
                                               href="index.php?c=chatA&a=deleteMessage&id=<?= (int)$m['id']; ?>&from_conversation=<?= (int)$conversation->getId(); ?>"
            ...
            <?php elseif ($page === 'messages'): ?>
                        ...
                        <table class="table table-striped table-hover mb-0">
                            ...
                            <?php foreach ($messages as $m): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-outline-primary"
                                           href="index.php?c=chatA&a=messages&edit_id=<?= $m->getId(); ?>">Edit</a>
                                        <a class="btn btn-sm btn-outline-danger"
                                           href="index.php?c=chatA&a=deleteMessage&id=<?= $m->getId(); ?>"
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form method="post" action="index.php?c=chatA&a=saveMessage">
                            <input type="hidden" name="id"
