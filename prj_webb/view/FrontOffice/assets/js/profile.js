document.addEventListener("DOMContentLoaded", () => {
    ...
    if(avatarInput && avatarImg){
        ...
        if(avatarForm){
            avatarForm.addEventListener("submit", function(e){
                ...
                fetch("../../controller/update_avatar.php", {method: "POST", body: formData})
                    .then(res => res.json())
                    .then(data => {
    ...
    if(profileForm){
        profileForm.addEventListener("submit", function(e){
            ...
            fetch("../../controller/update_profile.php", {method: "POST", body: new FormData(profileForm)})
                .then(res => res.json())
                .then(data => {
                    clearInputError(pseudo);
                    clearInputError(email);
    ...
    if(passwordForm){
        passwordForm.addEventListener("submit", function(e){
            ...
            fetch("../../controller/update_password.php",{method:"POST", body:new FormData(passwordForm)})
                .then(res => res.json())
                .then(data => {
                    clearInputError(current);
                    clearInputError(pswInput);
                    ...
                    if(data.errors){
                        ...
                        createLabel(pswInput,"Mot de passe modifié avec succès !",true);
                        passwordForm.reset();
                    }
                });
        });
