...
class ChatController
{
    ...
    public function index()
    {
        ...
        $page = 'auth';
        require __DIR__ . '/../view/F/index.php';
    }
    ...
    public function conversation()
    {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            header('Location: index.php?c=chat&a=conversation&id=' . $conversationId);
            exit;
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($mode === 'create') {
                ...
                if (empty($participantIds)) {
                    ...
                    header('Location: index.php?c=chat&a=conversation&id=' . $conv->getId());
                    exit;
                }
            }
        }
