...
require_once '../../model/User/Role.php';
...
<head>
    ...
    <link rel="stylesheet" href="../../view/LoginC/assets/css/edit_user.css">
</head>
<body>
<div class="dashboard-container">
    ...
    <form id="createRoleForm">
        ...
        <a href="../../view/Admin/UserB/dashboard.php" class="btn-logout">Annuler</a>
    </form>
</div>
<script src="../../view/LoginC/assets/js/create_role.js"></script>
</body>
</html>
