...
class AdminController
{
    private function requireAdmin()
    {
        if (!isset($_SESSION['user_id'])) {
            header('Location: index.php?c=chat&a=index');
            exit;
        }

        $user = User::findById((int)$_SESSION['user_id']);
        if (!$user || $user->getRole() !== 'back') {
            header('Location: index.php?c=chat&a=listConversations');
            exit;
        }
    }
    ...
    public function index()
    {
        ...
        $page = 'dashboard';
        require __DIR__ . '/../view/B/index.php';
    }
    ...
    public function saveConversation()
    {
        ...
        header('Location: index.php?c=admin&a=conversations');
        exit;
    }
    ...
    public function removeParticipant()
    {
        ...
        header('Location: index.php?c=admin&a=viewConversation&id=' . $conversationId);
        exit;
    }
    ...
    public function saveMessage()
    {
        ...
        header('Location: index.php?c=admin&a=messages');
        exit;
    }
    ...
    public function deleteMessage()
    {
        ...
        if ($fromConversation > 0) {
            header('Location: index.php?c=admin&a=viewConversation&id=' . $fromConversation);
        } else {
            header('Location: index.php?c=admin&a=messages');
        }
        exit;
